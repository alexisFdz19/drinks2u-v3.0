			...
			<?php
				...
				if($usuarioVerificado){
					...
					echo '<h3>Gracias</h3>
						...
						<h2><small>Hemos verificado su correo electrónico, ya puede ingresar a Drinks2u</small></h2>

						<br>

						<a href="#modaIngresar"><button class="btn btn-default backColorN btn-lg">Ingresar</button></a>';
					...
					<a href="#modalRegistro" data-toggle="modal"><button class="btn btn-default backColorN btn-lg">REGISTRO</button></a>';
