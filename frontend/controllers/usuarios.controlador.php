		...
		if(isset($_POST['mensajeContactenos'])){
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["emailContactenos"])){
				...
				=============================================*/
					...
					$mail->setFrom('Business_Drinks2u@outlook.com', 'Drinks2u');

					$mail->addReplyTo('Business_Drinks2u@outlook.com', 'Drinks2u');

					$mail->Subject = "Formulario de contacto Drinks2u";

					$mail->addAddress("Business_Drinks2u@outlook.com");
				...
				echo'<script>
					...
					swal({
						  title: "¡ERROR!",
						  text: "¡Error al enviar el mensaje, revise que no tenga caracteres especiales!",
						  type: "error",
						  confirmButtonText: "Cerrar",
						  closeOnConfirm: false
					},
